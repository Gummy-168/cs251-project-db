      ...
      theaters: [
        {
          ...
          type: 'DIGITAL 4K',
          showtimes: [
            { time: '20:00', price: '399.0' },
            { time: '22:30', price: '399.0' },
          ],
        },
        {
          id: 'Theater 2',
                ...
                {branch.theaters.map((theater, theaterIndex) => (
                  <div key={theaterIndex} className="bg-[#1b2b20] border border-[#2d4634] rounded-xl overflow-hidden shadow-sm">
                    ...
                    <div className="p-6 flex flex-col gap-4">
                      {theater.showtimes.map((show, showIndex) => (
                        <div 
                          key={showIndex} 
                        ...
                        >
                          ...
                          <button className="p-3 text-red-400/70 hover:text-red-400 hover:bg-red-400/10 rounded-lg transition-colors">
